...
{
    /// <inheritdoc />
    public partial class AddRemainingCrudTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkshopApplications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkshopApplications_ArtisanProfiles_ArtisanProfileId",
                        column: x => x.ArtisanProfileId,
                        principalTable: "ArtisanProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkshopApplications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkshopApplications_ArtisanProfileId",
                table: "WorkshopApplications",
                column: "ArtisanProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkshopApplications_UserId",
                table: "WorkshopApplications",
                column: "UserId");
        }
