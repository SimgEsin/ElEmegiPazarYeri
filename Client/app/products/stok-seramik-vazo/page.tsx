...
import { Clock3, Hammer, Heart, House, Leaf, Share2, ShieldCheck, ShoppingBag, ShoppingCart, SquareLibrary, Star } from "lucide-react"
...
const productImages = {
  ...
  thumbnails: [
    {
      src: "/images/products/gunesin-gozyasi-vazo/related-terra-tabak.jpg",
    ...
    },
    {
      ...
      alt: "Ürünün farklı açılardan sergilendiği görünüm.",
    },
    {
      src: "/images/products/gunesin-gozyasi-vazo/related-deniz-kup.jpg",
...
const ownerGalleryPhotos = [
  {
    src: "/images/products/gunesin-gozyasi-vazo/related-mini-kase.jpg",
    alt: "Stok seramik vazonun oturma odasında sergilendiği kullanıcı fotoğrafı.",
  },
  {
  ...
  {
    src: "/images/products/gunesin-gozyasi-vazo/hero.jpg",
    alt: "Vazonun gün ışığında formunu gösteren kullanıcı fotoğrafı.",
  },
  {
    src: "/images/products/gunesin-gozyasi-vazo/related-sutun-vazo.jpg",
    alt: "Vazonun farklı alanlarda kullanımına dair paylaşım.",
  },
]
...
const productDetail: ProductDetail = {
  ...
  quote:
    "\"Bu parça, beklemeden evine dokunsun diye hazırlandı. El işçiliğinin sıcaklığını korurken hızlı teslimat konforunu sunuyor.\"",
  story:
    "Stok Seramik Vazo, atölyede tamamlanmış ve kalite kontrolü yapılmış eserlerden biridir. Doğal sır dokusu, sade formu ve sıcak toprak tonlarıyla hem modern hem klasik yaşam alanlarına uyum sağlar. Özel sipariş bekleme süresi olmadan doğrudan standart ödeme adımlarıyla sipariş verilebilir.",
  material: "Avanos Kızıl Kili",
  technique: "Geleneksel Çark ve Sırlama",
  productionDuration: "2 Gün",
  handcraftDuration: "48 Saat",
  deliveryByMode: {
    ready_stock: "Tahmini teslimat: 2-4 iş günü",
  ...
  reviews: [
    {
      ...
      userExperience:
        "\"Siparişten kısa süre sonra elime ulaştı ve görseldekiyle birebir aynıydı. Sır geçişleri çok zarif, salonumda hemen odak noktası oldu.\"",
    },
    {
      author: "Kerem Y.",
      avatarInitial: "K",
      ...
      isVerifiedBuyer: true,
      userExperience:
        "\"Özel üretim beklemeden bu kaliteyi alabilmek çok iyi. Paketleme güvenliydi, ürün kusursuz geldi ve gerçekten el işçiliği hissediliyor.\"",
    },
  ],
}
...
const ctaHrefByMode: Record<ProductMode, string> = {
  ready_stock: "/products/stok-seramik-vazo/standart-siparis",
  made_to_order: "/products/gunesin-gozyasi-vazo/siparis-baslat",
}

const artisanProfileHref = "/artisans/zeynep-yilmaz"

export const metadata: Metadata = {
  title: "Stok Seramik Vazo | El Emeği Sanat",
  description: "Stok seramik vazo ürün detay sayfası.",
}
...
export default function StokSeramikVazoPage() {
    ...
    <div className="space-y-14 pb-10">
        ...
        <div className="grid grid-cols-1 gap-12 p-6 lg:grid-cols-2 lg:p-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-8 flex items-center gap-6 border-y border-primary/10 py-6">
              <div className="flex flex-col">
                <span className="text-sm text-muted-foreground">{productDetail.mode == "ready_stock" ? "Üretim Süresi" : "Ortalama Üretim Süresi"}</span>
            ...
            <div className="space-y-6">
              <div>
                <p className="leading-relaxed italic text-muted-foreground">{productDetail.quote}</p>
              </div>
              ...
              <div className="flex flex-col gap-4 pt-4">
                ...
                {productMode === "ready_stock" ? (
                  <div className="flex flex-col gap-3">
                    <Link
                      href={ctaHrefByMode[productMode]}
                    ...
                    <button
                      type="button"
                      className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-primary py-4 font-bold text-primary transition-colors hover:bg-primary/10"
                    >
      ...
      <section className="grid grid-cols-1 gap-12 lg:grid-cols-3">
        <article className="space-y-8 lg:col-span-2">
          ...
          <ProductStoryTeaser productSlug="stok-seramik-vazo" fallbackText={storyText} />
      ...
      <section className="rounded-xl border border-primary/10 bg-card p-6">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          ...
          <li>• Stok ürünlerde iade/değişim süreci, standart mesafeli satış kurallarına göre yürütülür.</li>
        </ul>
      </section>
